      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              We are a family-owned proprietary concern with expertise in design, fabrication, erection, and commissioning of industrial projects as per standard codes. Our unwavering commitment to quality, innovation, and customer satisfaction has been the cornerstone of our success.
            </p>
            <p className="text-gray-700 leading-relaxed">
              We look forward to partnering with you on your engineering and fabrication needs.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="rounded-3xl relative overflow-hidden border border-slate-200 bg-white p-8 shadow-sm"
          >
            <div className="relative h-80 w-60 overflow-hidden rounded-3xl bg-slate-200 shadow-inner">
              <Image
                src="/md_photo.jpeg"
                alt="MD photo"
                fill
